...
<div align="center"><img style="background: white;" src="..\..\svg\7mNDnjAy2c.svg"></div> 
    ...
    - 提高存储系统速度的两条途径
        1. 提高命中率 H
            ...
            <!-- $H' = \frac{H+n-1}{n}$ --> <img style="transform: translateY(0.1em); background: white;" src="https://render.githubusercontent.com/render/math?math=H'%20%3D%20%5Cfrac%7BH%2Bn-1%7D%7Bn%7D">，n为Cache中块大小与数据块重复使用次数的乘积，H是原来的命中率
